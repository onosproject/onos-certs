...
// GetCertManagerClientSet returns a Kubernetes clientset
func GetCertManagerClientSet() (clientset.Interface, error) {
	config, err := GetRestConfig()
	if err != nil {
		return nil, err
	}
	return clientset.NewForConfigOrDie(config), nil
}
